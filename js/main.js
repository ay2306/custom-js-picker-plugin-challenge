    ...
    function addQuotes() {
      ...
      $.getJSON(url, function (data) {
        ...
        if (current_element % 3 == 0) {
          ...
          $('body').append("<center><div class = 'row' id = _id_".concat(col, "></div></center>"));
        }

        $('#_id_' + parseInt(current_element / 3).toString()).append("<div class=\"outer-box col-md-4\"><div class = 'quote-box'>".concat(data.quoteText, "</div></div>"));
        current_element++;
      }, 'jsonp');
    }
  }, {
